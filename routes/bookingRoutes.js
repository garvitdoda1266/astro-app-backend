...
router.put("/:id/status", protect, updateBookingStatus);  // check for authorize roles as admin and astrologer, both can do this

// PUBLIC/USER: Get available slots for an astrologer for given date
router.get("/available-slots/:astrologerId", getAvailableSlots);
